        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "viewEvents.php">Concerts</a></li>';
                ...
                //links non database contents. *if logged out
                    ...
                    echo '<li><a href = "index.php">Home</a></li>';
                    echo '<li><a href = "events2.php">Concerts</a></li>';
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Concert Management System</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Taking care of all your concert needs!
                </p>
            </div>
        </div>
    </div>
